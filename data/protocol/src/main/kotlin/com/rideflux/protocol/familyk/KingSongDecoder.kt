...
object KingSongDecoder {
    ...
    private fun decodeLivePageA(frame: ByteArray, subIndex: Int): KingSongFrame.LivePageA {
        ...
        return KingSongFrame.LivePageA(
            ...
            // modeEnum is only meaningful when modeMarkerPresent; the
            // 0 default below conflates "no mode present" with an actual
            // mode value of 0, so consumers MUST gate on
            // modeMarkerPresent before interpreting it.
