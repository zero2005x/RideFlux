...
internal object StringResources {
    ...
    /**
     * Resource qualifiers RideFlux ships translations for.
     *
    ...
    fun readStrings(file: File): Map<String, String> {
        ...
        val factory = DocumentBuilderFactory.newInstance().apply {
            // These files are local build inputs, but the parser defaults
            // are worth pinning anyway: no DTDs, no external entities.
