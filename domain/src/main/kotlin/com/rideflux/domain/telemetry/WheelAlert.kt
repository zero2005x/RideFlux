...
sealed class WheelAlert {
    ...
    data class OverTemperature(
        ...
        val source: Source,
        /**
         * Reported temperature in °C, or `null` when the family did not
         * report a reading for this source (sensor unavailable or the
         * alert carries no temperature payload). `null` does NOT mean
         * "0 °C".
         */
    ...
    data class FaultSetChanged(
        ...
        init {
            require(added.intersect(removed).isEmpty()) {
                "added and removed fault sets must be disjoint"
            }
        }
    }
