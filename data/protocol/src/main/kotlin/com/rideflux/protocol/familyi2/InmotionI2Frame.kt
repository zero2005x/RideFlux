...
data class InmotionI2Frame(
    ...
    // [cmdRawHighBitSet] is a receive-path diagnostic and is
    // intentionally EXCLUDED from equals/hashCode: two frames with
    // identical command + payload but different raw high bits are the
    // same value for deduplication/Set/Map use.
